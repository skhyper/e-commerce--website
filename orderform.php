...
<body style="background-image: url(image/homebackgrndimg1.jpg);">
	...
	$result = mysql_query("SELECT * FROM user WHERE id='$user'");
		$get_user_email = mysql_fetch_assoc($result);
			...
			echo '<h3 style="color:#169E8F;font-size:45px;"> Total: '.$quan * $price.' Rupees</h2>';
							...
							<form action="" method="POST" class="registration">
								...
								<h3 style="color:red;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
									...
									Types of Delivery <br>
									 ...
									 <input name="Delivery" required="required" value="Express Delivery +100 Rupees upon cash on delivery" type="radio"  placeholder="Mode Of Payment"> Express Delivery </br>
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="'.$category.'/view_product.php?pid='.$id.'">
									...
									<div style="text-align: center; padding: 0 0 6px 0;"> <span style="font-size: 15px;">'.$pName.'</span><br> Price: '.$price.' Rupees</div>
								</div>
